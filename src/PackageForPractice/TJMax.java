...
import java.util.List;
	...
	public class TJMax {
	    ...
	    public List<String> getAllItemNames() {
	     ...
	     for (OnSaleItem itm:onSaleItems){
	         itemsName.add(itm.getName());
	       return itemsName;
	    }
	    }
	    /**
	    ...
	    public double getItemPrice(int catalogNumber) {
	       for (Item it:regularItems){
	         if(it.getCatalogNumber()==catalogNumber){
	           return it.getPrice();
	         }else{
            return 0.0 ;
	         }
	    ...
	    public void removeItem(int catalogNumber) {
	        for(Item it:regularItems){
	          if (it.getCatalogNumber()==catalogNumber){
	            regularItems.remove(it);
	            break;
	          }
	        }
	        for (OnSaleItem it:onSaleItems){
	          if(it.getCatalogNumber()==catalogNumber){
	            onSaleItems.remove(it);
	            break;
	          }
	        }
	    }
