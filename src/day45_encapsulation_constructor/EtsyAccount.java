...
//constractor 1. no-args.sets all as empty string
...
//constractor 2.takes 3 args and sets them to instanse variebls 
//using setters
...
//constractor 3 
//email , firstName -->call seters
//password is auto generated and assidned 
...
private String getRandomPassword() {
	...
	String rdPassword = "";
	for(int i = 1; i <= 6; i++) {
		rdPassword+=letters.charAt( rd.nextInt( letters.length()));//from 0 antil 34
	}
	return rdPassword;
}
...
public void setFirstName(String firstName) {
	//Cant be blank
	//needs to be Alphabetic letters
	
	//valid all letters , can have space in middle
	//invalid  can not contain numbers or any other chars
