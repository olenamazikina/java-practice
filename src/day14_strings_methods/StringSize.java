...
public static void main(String[] args) {
	...
	//check if it matches "Good morning" angprint match
	//or not match
	if (str1.equals("Good morning")) {
	System.out.println("Match");
    }else {
	System.out.println("Not Match");
	if (str1.equalsIgnoreCase("good mornimg")) {
		System.out.println("March ignorecase");
	}else {
		System.out.println("Not Match");
	}
	...
	//cover to all lowercase first check if it equals("good morning)
	...
	//set some value and using a if ststement check it is
	...
	if (userName.length()==8) {
		...
		System.out.println("Invalid username,must bre 8 chars");
