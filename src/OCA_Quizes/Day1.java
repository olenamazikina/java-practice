...
public class Day1 {
	...
	System.out.println(Arrays.toString(arr));//answer C.hashcodes
	
	 /* 2. which one of the following will give compile error?
			     
		        A. int[][] arr=new int[2][];[index num of single dimentional array] [index num of elements in 1d array].
		        B. double[][] arr=new double[][] { {1,2}, {3,4} };
		        C. long[][] arr=new long[2][] { {1,2}, {3,4} };//answer
		        D. int[][] arr ={ {'A', 'B'}, {'C' , 'D' } };
	...
	//	long[][] arr9=new long[2][] { {1,2}, {3,4} };
	     ...
	     */
		int[][] arr = { {1,2,3}, {3,4} };
        for(int i=0; i<2; i++) {//start from i=0,i=1;
        	
        }
            for(int j=0; j<2; j++) {//start from j=0,j=1
                System.out.println(arr[i][j]+" ");//[0][0]---i;[0][1]==j    /// [1][0]---i;[1][1]==j 
	    ...
	    /*
	     ...
	      4. Which Three lines fail to compile?
	            ...
	            3   float fvar = 200; 
	            4       ivar = fvar;//error
	            5       fvar = ivar;//compaile
	            6       dvar = fvar;//compaile
	            7       fvar = dvar;//error
	            8       dvar = ivar; //compaile
	            9       ivar = dvar;//error
	            
	        A. line 3, line 5, line 8                        B. line 4, line 7, line 9 cerrect ansver
	        C. line 5, line 6, line 9                        D. line 4, line 5, line 8
	     
	     */
	    
	        
                B. line 4, line 7, line 9 cerrect ansver
	    ...
	    System.out.println("5 + 2 = "+(3+4));
	       ...
	       /*
	          8. What's the result?
	           ...
	           C. false     false  //correct answer                 D. true    false
	     
	     
	       */
	    
	    String str = " ";
      str= str.trim();//if you put str =
    System.out.println(str.equals("") +"   "+str.isEmpty());    
}
	        ...
	        /*
	            ...
	            A.  3 4 1 2  //correct answer                       B. 1 2 3 4
	            C.  4 3 2 1                                      D. 2 1 3 4
	            
	         
	         */
            int[][] arr=  { {1,2}, {3,4} };
            for(int i=arr.length-1; i>=0; i-- ) {//i=1  i=0;
                for(int j=0; j<arr.length; j++) {//j=0; j=1;
                    System.out.println(arr[i][j]+" ");//i=[1][0] j=[1][1]   [0][0] j=[0][1]
                }                                     //3             4        1        2
	        ...
	        /*
	             10. Which statement is true about Java byte code?
	                  ...
	                  C. It can run on any platform that has the Java Runtime Environment.//correct answer 
